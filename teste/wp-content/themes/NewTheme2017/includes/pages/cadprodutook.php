				...
				<div id="banner" class="box container">
					<div class="row">
						<?php
						  ...
						  $query = "INSERT INTO wp_produtos(produto_id, produto_nome, produto_descricao, produto_preco)
						  VALUES (NULL, '".$_REQUEST['produto_nome']."', '".$_REQUEST['produto_descricao']."', '".$_REQUEST['produto_preco']."')";
						  mysql_query($query);
						  mysql_close($con);
						?>
					</div>
					<div class="row">
						<div class="7u">
							<p><h3>Produto Cadastrado com Sucesso!</h3></p>
						</div>
					</div>
				</div>
			</div>
