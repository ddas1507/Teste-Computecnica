				...
				<div id="banner" class="box container">
					<div class="row">
						<?php
						  ...
						  $query = "INSERT INTO wp_clientes(cliente_id, cliente_nome, cliente_email, cliente_telefone)
						  VALUES (NULL, '".$_REQUEST['cliente_nome']."', '".$_REQUEST['cliente_email']."', '".$_REQUEST['cliente_telefone']."')";
						  mysql_query($query);
						  mysql_close($con);
						?>
					</div>
					<div class="row">
						<div class="7u">
							<p><h3>Cliente Cadastrado com Sucesso!</h3></p>
						</div>
					</div>
				</div>
			</div>
