		...
		<div id="page-wrapper">
				<div id="banner-wrapper">
					<div id="banner" class="box container">
						<div class="row">
							<div class="7u">								
								<p><h3>Clientes Cadastrados</h3></p>
							</div>
						</div>
						...
						<div class="row">
							...
							?>
									 <tr><td><?php echo $linha['cliente_id'];?></td><td><?php echo $linha['cliente_nome'];?></td></tr> 
							...
							<table style="border: 1px solid #efefef;" id="listagem">
								...
								?>
									<tr style="font-size: 11px;">
										...
										<td style="text-align: center;"><?php echo $linha['cliente_nome'];?></td>
										<td style="text-align: center;"><?php echo $linha['cliente_email'];?></td>
										<td style="text-align: center;"><?php echo $linha['cliente_telefone'];?></td>
										<td>
